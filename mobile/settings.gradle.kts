...
include(":feature:popularregion:api")
include(":feature:popularregion:impl")
include(":feature:randomtravel:api")
include(":feature:randomtravel:impl")
include(":feature:regionbriefing:api")
include(":feature:regionbriefing:impl")
