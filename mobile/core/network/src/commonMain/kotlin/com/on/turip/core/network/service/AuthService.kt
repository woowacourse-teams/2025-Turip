...
interface AuthService {
    ...
    suspend fun postLogin(@Body body: LoginIdTokenPostRequest): LoginJwtTokenResponse

    @POST(ApiPath.V1 + "auth/guest")
    suspend fun postGuestLogin(): LoginJwtTokenResponse

    @POST(ApiPath.V2 + "auth/reissue")
    suspend fun postReissueToken(@Body body: ReissueTokenRequest): ReissueTokenResponse
}
