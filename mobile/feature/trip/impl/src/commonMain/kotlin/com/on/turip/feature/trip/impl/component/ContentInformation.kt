...
fun ContentInformation(
    ...
    Column(modifier = modifier.padding(horizontal = TuripTheme.spacing.extraLarge)) {
        ...
        Column {
            ...
            ContentInfoItem(
                label = stringResource(Res.string.trip_detail_period),
                text = information.duration.toDisplayText(),
            ...
            ContentInfoItem(
                label = stringResource(Res.string.trip_detail_visit_place),
                text =
                    stringResource(
                        Res.string.trip_detail_day_place_count,
