...
public class MemberController {
    ...
    @Operation(
            summary = "마이그레이션 거절 api",
            description = "마이그레이션을 거절한다."
    )
    @ApiResponses(value = {
            @ApiResponse(
                    responseCode = "204",
    ...
    @PostMapping("/migration/reject")
    public ResponseEntity<Void> rejectMigrate(@Parameter(hidden = true) @AuthMember Member member) {
