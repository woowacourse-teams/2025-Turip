...
class AuthApiTest {
    ...
    @Nested
    @DisplayName("/api/v1/login/turip POST 자체 로그인 테스트")
    ...
    @Nested
    @DisplayName("/api/v1/login/google POST 구글 로그인 테스트")
    ...
    @Nested
    @DisplayName("/api/v1/token POST 토큰 갱신 테스트")
    class RefreshTest {
    ...
    @Nested
    @DisplayName("/api/v1/logout POST 로그아웃 테스트")
    class LogoutTest {
