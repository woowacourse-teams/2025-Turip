...
fun SearchEmptyView(
    ...
    Column(
        ...
        Text(
            text = stringResource(R.string.search_result_no_result, searchKeyword),
        ...
        Row(
            ...
            Text(
                text = stringResource(R.string.search_result_tip),
            ...
            Text(
                text = stringResource(R.string.search_result_tip_region),
