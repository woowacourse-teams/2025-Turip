package com.on.turip.ui.compose.invitation.util
...
object InvitationTokenParser {
    ...
    fun extractTokenFromInstallReferrer(installReferrer: String?): String? {
        ...
        val queryOrRaw = extractQueryOrRaw(installReferrer)
    ...
    private fun extractQueryParameter(
        ...
        query
            ...
            .mapNotNull { parameter: String ->
                ...
                val name = decode(parameter.substring(0, delimiterIndex))
                if (name != key) return@mapNotNull null

                decode(parameter.substring(delimiterIndex + 1))
